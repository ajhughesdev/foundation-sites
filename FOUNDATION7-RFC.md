...
This repository currently contains the Foundation Sites 6.x codebase (Sass-first + jQuery plugins + Gulp/Webpack/Rollup release pipeline).
Foundation 7 is a **breaking** redesign that targets modern JavaScript, modern CSS, and an evergreen browser baseline.

This document is an initial implementation-oriented RFC to guide the first code changes landing in this repo.
...
This RFC starts by introducing a `packages/` workspace-style layout without deleting the existing Foundation 6.x code.
